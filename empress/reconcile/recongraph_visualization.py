...
def _event_node_to_str(event_node):
    ...
    if _event_node_type(event_node) == "S":
        return "spec | {}-{}, {}-{}".format(
            event_node[1][0], event_node[1][1], event_node[2][0], event_node[2][1]
        )
    ...
    for mappingNode, event_nodes in list(dtl_graph.items()):
        ...
        for event_node in event_nodes:
            ...
            # other types have two children
                ...
                next_mapping_node_name1 = _mapping_node_to_str(
                    _second_child(event_node)
                )
...
def visualize_and_save(dtl_graph, target_file):
    ...
    try:
        ...
        print(
            "Graphviz not installed. Cannot render image as .png, saved as .gv instead",
            file=sys.stderr,
        )
        print(
            "You can visualize the .gv file in http://www.webgraphviz.com/",
            file=sys.stderr,
        )
