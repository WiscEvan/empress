...
class TestInputReader(unittest.TestCase):
    ...
    def test_init_invalid_parasite_tip_error(self):
        ...
        self.assertRaises(
            input_reader.ReconInputError,
            input_reader._ReconInput,
            self.example_host,
            None,
            self.example_parasite,
            None,
    ...
    def test_read_invalid_tip_error(self):
        ...
        self.assertRaises(
            input_reader.ReconInputError,
            recon_input.read_mapping,
            self.example_invalid_mapping_file,
        )

    def test_from_files_success(self):
        recon_input = input_reader._ReconInput.from_files(
            self.example_host_file,
            self.example_parasite_file,
            self.example_mapping_file,
        )
        self.assertTrue(recon_input.is_complete())
    ...
    def test_from_files_type_error(self):
        self.assertRaises(
            input_reader.ReconInputError,
            input_reader._ReconInput.from_files,
            self.example_host_file,
            12345,
            self.example_mapping_file,
        )
    ...
    def test_write_to_file(self):
        ...
        recon_input.save_to_files(
            host_save_path, parasite_save_path, tip_mapping_save_path
        )
        ...
        result_input = input_reader._ReconInput.from_files(
            host_save_path, parasite_save_path, tip_mapping_save_path
        )
