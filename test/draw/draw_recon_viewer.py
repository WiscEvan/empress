...
class DrawReconViewer(unittest.TestCase):
    ...
    def test_render_1(self):
        fig = recon_viewer.render(
            self.host_dict1,
            self.parasite_dict1,
            self.recon_dict1,
            event_frequencies=None,
    ...
    def test_render_3(self):
        ...
        fig = recon_viewer.render(
            ...
            reconciliation.event_frequencies,
            show_internal_labels=True,
            show_freq=True,
        )
    ...
    def test_render_with_frequency_1(self):
        ...
        recon_input = empress.ReconInputWrapper.from_files(
            example_host, example_parasite, example_mapping
        )
        ...
        fig = recon_viewer.render(
            recon_input.host_dict,
            recon_input.parasite_dict,
            median_reconciliation._reconciliation,
            median_reconciliation.event_frequencies,
            show_internal_labels=True,
            show_freq=True,
        )
